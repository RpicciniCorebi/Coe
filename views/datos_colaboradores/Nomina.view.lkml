...
view: nomina_2 {
  ...
  sql_table_name: `datos_colaboradores.Nomina_2`
    ;;
  ...
  dimension: Vertical {
    ...
    sql:
    CASE
      WHEN ${puesto} in ('Data Viz', 'Data Analyst', 'ATF', 'DataViz') THEN 'Data Viz & BI'
      WHEN ${puesto} = 'Data Engineer' THEN 'Data Engineer'
      WHEN ${puesto} = 'Data Scientist' THEN 'Data Scientist'
    END;;
  }
